...
func (c *captchaService) GetCaptcha(ctx context.Context, in *Request, opts ...client.CallOption) (*Response, error) {
...
func (h *captchaHandler) GetCaptcha(ctx context.Context, in *Request, out *Response) error {
